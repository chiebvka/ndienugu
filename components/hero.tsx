...
export default function Hero() {
  ...
  const slides = [
    ...
    {
      title: "Using projects to connect Ndi Enugu in Scotland and Enugu State",
  ...
  return (
    <div className="relative bg-black text-white overflow-hidden">
      <div className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[700px] lg:min-h-[800px]">
        ...
        <div className="container mx-auto px-4 py-16 sm:py-24 md:py-32 lg:py-40 relative z-20 h-full flex flex-col justify-center">
          <div className="max-w-3xl">
            {slides.map((slide, index) => (
              ...
              >
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6">{slide.title}</h1>
      ...
      <div
        className={`container mx-auto px-4 pb-12 md:pb-0 md:absolute md:bottom-8 md:left-0 md:right-0 md:z-30 transition-all duration-1000 transform ${
          isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0 md:translate-y-0"
        }`}
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="glass-card p-6 flex rounded-lg items-center space-x-4 hover:shadow-xl transition-all group backdrop-blur-lg bg-white/10">
            ...
            <div className="min-w-0">
              <h3 className="font-bold text-white truncate">Projects & News</h3>
          ...
          <div className="glass-card p-6 flex rounded-lg items-center space-x-4 hover:shadow-xl transition-all group backdrop-blur-lg bg-white/10 sm:col-span-2 md:col-span-1">
            ...
            <div className="min-w-0">
              <h3 className="font-bold text-white truncate">Executive members</h3>
