import type { BoardMember, PatronMember } from "@/types"
import BoardMemberCard from "@/components/board-member-card"
import PageHeader from "@/components/page-header"
import Patronmember from "@/components/patron-member"
...
const boardMembers: BoardMember[] = [
  ...
  },
  {
    ...
    name: "Chukwudi Orji",
    position: "Treasurer",
    bio: "Chukwudi Orji  BSc Nig, MSc Lagos, MA London, MSc Aberdeen. I am a determined, open and dedicated person who always desire to achieve and excel. I work well independently and play active role in a team, able to lead when required. Communicate effectively with people of all ages and backgrounds, work collaboratively to resolve problems and motivate team members to achieve personal and organisational objectives. I have experience in finance, criminal justice, children and family, homelessness and health. I always employ high interpersonal, liaison, analytical and decision-making skills to multiple functions and continuously seek self development and opportunities to apply knowledge and experience to practice. Born in Kano From Enugu State Residents in Scotland Married with children",
...
const patronMembers: PatronMember[] = [
  {
    id: 1,
...
export default function BoardPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <PageHeader
        title="Executive & Patron Members"
